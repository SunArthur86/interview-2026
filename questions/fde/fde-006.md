...
<img src="/interview-2026/images/diagram_fde_fde-006.svg" alt="如何为客户选择合适的 LLM API?应该考虑哪些因素 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
