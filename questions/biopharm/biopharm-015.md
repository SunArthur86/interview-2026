...
first_principle:
  ...
  rebuild: 建数据治理体系——合规框架落地 + 隐私脱敏（去标识/差分隐私）+ 权限分级（敏感级+最小授权）+ 全链路审计（数据/AI决策可追溯）+ 可解释，让医药
    AI 在合规底线之上运行。
follow_up:
...
flowchart LR
  ...
  subgraph Body["📚 讲解"]
    N2["0:15<br/>安全防御"]:::concept
    N3["0:50<br/>隐私脱敏"]:::deep
    N4["1:20<br/>权限分级"]:::concept
    N5["1:50<br/>全链路审计"]:::deep
  end
  subgraph Outro["🎯 收尾"]
