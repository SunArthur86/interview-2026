...
<img src="/interview-2026/images/diagram_database_note-xhs-db-010.svg" alt="Redis 数据类型有哪些？各自的应用场景？（华为od Java一面） - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
