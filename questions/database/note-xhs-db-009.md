...
<img src="/interview-2026/images/diagram_database_note-xhs-db-009.svg" alt="Redis Bitmap 是怎么实现的？set/get 一个 bit 底层做了什么？（小红书Java一面） - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
