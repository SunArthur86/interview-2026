...
<img src="/interview-2026/images/diagram_database_db-108.svg" alt="如何用 EXPLAIN 分析和优化慢 SQL？重点关注哪些字段？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
