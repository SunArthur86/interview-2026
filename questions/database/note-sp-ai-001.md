...
<img src="/interview-2026/images/diagram_database_note-sp-ai-001.svg" alt="MySQL和PgSQL的区别？分别用什么数据结构实现索引？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
