...
<img src="/interview-2026/images/diagram_database_tr5-003.svg" alt="对比MySQL的B+树与HBase的LSM树，在海量数据写入场景下为什么LSM树性能更优？LSM树又是如何解决读取性能问题的？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
