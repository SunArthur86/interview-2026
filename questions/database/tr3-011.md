...
<img src="/interview-2026/images/diagram_database_tr3-011.svg" alt="PostgreSQL的pgvector扩展在使用HNSW索引进行向量检索时，是如何平衡查询精度与召回率的？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
