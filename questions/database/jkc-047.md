...
<img src="/interview-2026/images/diagram_database_jkc-047.svg" alt="super column（SQL数据库不支持） - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
