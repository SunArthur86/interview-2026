...
<img src="/interview-2026/images/diagram_ai_note-bd-llm-010.svg" alt="【字节面经】你提到做过多模态文档解析，当图片里的文字与周边正文语义强相关时，你是怎么把两者的上下文关联保留下来的？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
