...
<img src="/interview-2026/images/diagram_ai_note-bg-003.svg" alt="【八股总结】业务基模和通用基模有什么区别？业务基模效果如何评估？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
