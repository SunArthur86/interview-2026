...
first_principle:
  ...
  derivation: 用户意图本身具有模糊性(同一句话可能对应多个意图) → 模型输出概率分布而非单一答案 → 下游有澄清/交互机制 → Top-K中包含正确意图即有价值
    → 所以hit@3比hit@1更贴合实际效果
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["意图识别准确率为什么统计hit@3…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["核心概念图<br/>0:20"]:::core
        N2["hit@1过于严格示意图<br/>0:50"]:::deep
    end
