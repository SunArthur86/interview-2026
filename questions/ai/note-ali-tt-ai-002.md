...
<img src="/interview-2026/images/diagram_ai_note-ali-tt-ai-002.svg" alt="【阿里淘天AI二面】Multi-Agent是如何共享上下文的？子Agent会使用父Agent的所有Context吗？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
