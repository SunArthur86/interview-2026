...
feynman:
  ...
  analogy: 降低幻觉就像防漏水——水龙头拧紧(Prompt约束减少幻觉)、接水盆兜底(RAG提供事实)、湿度报警器(自动测试检测错误)、自动修补(Auto
    Fix修复)、最后人工检查(Human-in-the-loop)
  key_points:
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["如何降低大模型幻觉导致的错误代码？<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["核心概念图<br/>0:20"]:::core
        N2["幻觉来源示意图<br/>0:50"]:::deep
        N3["Prompt层示意图<br/>1:30"]:::deep
    end
