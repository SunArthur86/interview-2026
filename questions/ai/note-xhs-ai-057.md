...
<img src="/interview-2026/images/diagram_ai_note-xhs-ai-057.svg" alt="【拼多多二面】用Java实现AI Agent：ToolCalling和会话记忆设计 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
