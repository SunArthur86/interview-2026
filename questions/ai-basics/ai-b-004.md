...
flowchart LR
    ...
    class R2 start
    class R3 process
    class Root_Cause decision
    class S1 special
    class S2 error
    class S3 info
    class SAM start
    class SoM process
    class Solutions decision
    class VCD special
    class VLM error
    class VLM_Hallucination info
    class br start
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["VLM 幻觉问题<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["指鹿为马类比<br/>0:15"]:::core
        N2["VLM vs 纯文本幻觉对比<br/>0:40"]:::core
        N3["三种幻觉类型图<br/>1:05"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["对比解码 VCD 公式<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["自动驾驶红灯误报案例<br/>1:55"]:::wrap
    end
