...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《LLM 安全纵深防御》+ 路…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["模型层对齐：RLHF / DPO 调概率<br/>0:25"]:::core
        N2["系统提示词 + 输入输出护栏<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["红队测试 + 第二层裁判<br/>1:25"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["平衡点：避免误杀 + 动态阈值<br/>1:50"]:::wrap
    end
