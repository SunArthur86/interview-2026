...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《多模态 Few-shot 示…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["相似性原则：语义 + 视觉双重检索<br/>0:25"]:::core
        N2["混合检索：文本语义 + 图像特征加权<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["顺序敏感：最相似示例放 Query 最近处<br/>1:25"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["Token 权衡 + 低质降级 Zero-shot<br/>1:50"]:::wrap
    end
