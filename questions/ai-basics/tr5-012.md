...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《思维树 ToT》+ 走迷宫 …<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["线性链 vs 树状结构对比图<br/>0:25"]:::core
        N2["流程图：生成分支 → 评估节点 → 搜索剪枝<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["对比 CoT：无法回溯 vs 主动放弃错误分支<br/>1:25"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["风险提示：指数级爆炸需限宽限深<br/>1:50"]:::wrap
    end
