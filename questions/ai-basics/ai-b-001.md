...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["BERT MASK 独立性<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["完形填空独立填空类比<br/>0:15"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["Paris 双 MASK 例子<br/>0:40"]:::practice
        N3["BERT vs GPT 对比表<br/>1:05"]:::practice
        N4["三种改进方案图<br/>1:30"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["10% 随机词为 Embedding 校准<br/>1:50"]:::wrap
    end
