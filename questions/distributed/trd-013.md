...
<img src="/interview-2026/images/diagram_distributed_trd-013.svg" alt="作为 Java 后端，如何接入大语言模型（LLM）实现 RAG（检索增强生成）？Vector Database 在其中扮演什么角色？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
