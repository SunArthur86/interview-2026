...
<img src="/interview-2026/images/diagram_distributed_scn-005.svg" alt="什么是分层JAR(Layered Jar)？它如何优化Docker镜像构建？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
