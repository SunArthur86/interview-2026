...
<img src="/interview-2026/images/diagram_network_note-netty-004.svg" alt="Netty 的异步和事件驱动机制是怎样的？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
## 结构化回答
