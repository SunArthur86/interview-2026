...
<img src="/interview-2026/images/diagram_network_note-netty-014.svg" alt="Netty 的编解码器（Codec）机制？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
## 结构化回答
