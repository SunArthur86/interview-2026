...
<img src="/interview-2026/images/diagram_network_note-netty-002.svg" alt="Java 三种 IO 模型 BIO / NIO / AIO 的区别？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
## 结构化回答
