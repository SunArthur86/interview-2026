...
<img src="/interview-2026/images/diagram_network_note-netty-006.svg" alt="Channel 的作用是什么？为什么是线程安全的？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
## 结构化回答
