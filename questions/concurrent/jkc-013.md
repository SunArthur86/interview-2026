...
<img src="/interview-2026/images/diagram_concurrent_jkc-013.svg" alt="ThreadLocalMap（线程的一个属性） 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
