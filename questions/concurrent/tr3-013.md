...
<img src="/interview-2026/images/diagram_concurrent_tr3-013.svg" alt="ScheduledThreadPoolExecutor在处理大量短周期延时任务时为什么会成为性能瓶颈？JDK新引入的时间轮是如何解决的？ 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
