...
<img src="/interview-2026/images/diagram_jvm_trd-001.svg" alt="JDK 21 引入的虚拟线程与传统的平台线程在底层调度模型上有何本质区别？在 I/O 密集型场景下，虚拟线程如何解决“池化焦虑”问题？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
