...
<img src="/interview-2026/images/diagram_jvm_tr4-002.svg" alt="使用 MAT 分析内存泄漏时，Dominator Tree（支配树）和 Histogram（直方图）有什么区别？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
