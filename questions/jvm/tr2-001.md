...
<img src="/interview-2026/images/diagram_jvm_tr2-001.svg" alt="在生产环境中，JVM 发生 OOM（内存溢出）后，你通常会保留哪些现场证据？利用 MAT 工具分析 heap dump 文件时，如何快速定位到造成内存泄漏的嫌疑对象？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
