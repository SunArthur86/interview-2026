...
<img src="/interview-2026/images/diagram_jvm_tr3-004.svg" alt="GraalVM Native Image在构建时无法通过反射访问类，除了编写反射配置文件，还有哪些更现代的解决方案？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
