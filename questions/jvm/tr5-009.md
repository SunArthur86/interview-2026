...
<img src="/interview-2026/images/diagram_jvm_tr5-009.svg" alt="在Java中，对象是如何在堆内存中布局的？请解释对象头包含哪些信息，以及这些信息在锁升级过程中起到了什么作用？" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
