...
flowchart LR
    ...
    subgraph Intro["引入"]
        A["什么场景选 MongoDB 而不是 MySQL？MongoD…"]:::intro
    end

    subgraph Core["讲解"]
        B["选MongoDB因为其Schema灵活，加字段无需D…"]:::core
        C["文档模型采用BSON内嵌存储，解决了深层关联需多次J…"]:::deep
    end
