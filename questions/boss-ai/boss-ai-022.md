...
<img src="/interview-2026/images/diagram_boss-ai_boss-ai-022.svg" alt="【巨剧核 AI 陪伴】LLM 接入工程化怎么做（统一接口/多模型/错误处理）？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
