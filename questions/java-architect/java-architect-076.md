...
flowchart TB
    ...
    Build --> License["4. License 合规扫描<br/>依赖许可证"]
    UT --> Integration
    Sonar --> Integration
    License --> Integration
    Integration["5. 集成测试<br/>+ 安全扫描（Trivy）<br/>+ 镜像构建"]
    Integration --> Artifact["6. 制品入库<br/>digest + SBOM<br/>+ 测试报告绑定"]
    Artifact -->|"合并到 main"| Deploy["7. 部署<br/>dev → staging → prod<br/>金丝雀 + 自动回滚"]
```
...
<img src="/interview-2026/images/diagram_java-architect_java-architect-076.svg" alt="核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
