...
<img src="/interview-2026/images/diagram_ai-harness_ai-h-026.svg" alt="Phoenix(Arize)如何实现LLM可观测性?它和LangSmith有什么区别 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
