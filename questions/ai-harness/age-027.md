...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《熔断器模式》+ 保险丝断电试…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["三状态流转：Closed → Open → Half-…<br/>0:25"]:::core
        N2["Half-Open 探测：仅放 1-3 个请求<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["关键参数：失败率 50% / 最小 20 / 时长 3…<br/>1:30"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["降级策略：缓存/切供应商/小模型/友好错误<br/>1:55"]:::wrap
    end
