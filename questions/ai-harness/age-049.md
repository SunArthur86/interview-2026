...
<img src="/interview-2026/images/diagram_ai-harness_age-049.svg" alt="为什么 LLM API 都用 SSE(Server-Sent Events)做流式输出?和 WebSocket 有什么区别 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
