...
<img src="/interview-2026/images/diagram_ai-harness_age-026.svg" alt="如何设计一个多模型网关的架构?模型路由策略有哪些 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
