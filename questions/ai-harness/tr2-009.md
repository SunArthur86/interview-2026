...
<img src="/interview-2026/images/diagram_ai-harness_tr2-009.svg" alt="评测 Agent 系统质量时，传统 NLP 指标（如 BLEU/ROUGE）有哪些局限性？Eval Harness 框架通常采用什么维度进行自动化评估？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
