...
flowchart TD
    ...
    class AWQ start
    class Accuracy process
    class CPU decision
    class Choice special
    class GGUF error
    class GPTQ info
    class Personal start
    class Speed process
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["模型量化方案GGUF vs AWQ…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["通过降低模型参数精度（如FP16转为INT4）来<br/>0:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["GGUF 专攻 CPU/端侧，单文件分发，支持极<br/>1:00"]:::practice
    end
