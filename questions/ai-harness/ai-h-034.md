...
<img src="/interview-2026/images/diagram_ai-harness_ai-h-034.svg" alt="RAG知识库如何实现增量更新?大规模文档变更时索引如何高效更新 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
