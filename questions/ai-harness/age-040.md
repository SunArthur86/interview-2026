...
<img src="/interview-2026/images/diagram_ai-harness_age-040.svg" alt="生产级 Agent 的可观测性(Observability)怎么做?需要追踪哪些指标 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
