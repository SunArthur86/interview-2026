...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["模型路由与容错<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["通过策略分发请求和故障隔离，保障AI服务高可用且<br/>0:40"]:::core
        N3["容错机制图解<br/>2:00"]:::core
        N4["降级策略图解<br/>2:40"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["模型路由根据成本、延迟、任务类型，动态分发请求至<br/>1:20"]:::practice
    end
