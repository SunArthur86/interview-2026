...
<img src="/interview-2026/images/diagram_ai-harness_ai-h-013.svg" alt="如何选择和部署Reranker?自建Reranker vs API Reranker - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
