...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《Agent 为何需要 Tra…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["传统服务固定路径 vs Agent 动态分支<br/>0:20"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["Span 增强示意：Thought/Tool Call…<br/>0:50"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N3["排查价值：定位检索/模型/工具环节<br/>1:15"]:::wrap
    end
