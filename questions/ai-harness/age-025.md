...
<img src="/interview-2026/images/diagram_ai-harness_age-025.svg" alt="为什么 Agent 更需要「版本化」的 Prompt 与模型 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
