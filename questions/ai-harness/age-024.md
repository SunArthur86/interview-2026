...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《Semaphore 设多大》…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["上限依据：供应商 RPM/TPM + 本机 + 下游<br/>0:25"]:::core
        N2["压测定值：找拐点，生产设 70-80%<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["分层隔离：全局 Semaphore + 租户分桶<br/>1:25"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["动态调整：监控 429 自适应<br/>1:50"]:::wrap
    end
