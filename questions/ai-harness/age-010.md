...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《Streaming 与计费日…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["计费流程：等待流结束 + usage 字段<br/>0:25"]:::core
        N2["日志两种模式对比：聚合 vs 增量<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["断连示意：网关主动中断上游<br/>1:25"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["对账：以服务端 usage 为准<br/>1:50"]:::wrap
    end
