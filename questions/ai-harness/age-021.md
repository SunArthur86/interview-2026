...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["标题《幻觉率升高排查》+ 看病问诊…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["分层排查：宏观指标 → 租户/Prompt/模型下钻<br/>0:25"]:::core
        N2["变更审查：模型漂移/Prompt 修改/索引更新<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["链路抽样：Trace ID 看召回上下文<br/>1:25"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["离线验证：黄金测试集回测<br/>1:50"]:::wrap
    end
