...
<img src="/interview-2026/images/diagram_ai-harness_ai-h-008.svg" alt="Outlines库如何实现100%结构化输出?约束解码的原理是什么 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
