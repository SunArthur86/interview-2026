...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Reflexion vs 自检<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["两种模式对比图<br/>0:15"]:::core
        N2["外部 Evaluator 流程图<br/>0:45"]:::core
        N3["反思记忆累积动画<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["SQL 生成案例截图<br/>1:35"]:::practice
    end
