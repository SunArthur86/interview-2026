...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["三种沙箱技术<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["合租/胶囊/别墅类比图<br/>0:15"]:::core
        N3["Docker 加固配置代码<br/>1:15"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N2["三技术对比表<br/>0:45"]:::practice
        N4["mount 逃逸换 Firecracker 案例<br/>1:40"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["口诀：隔离递增 Docker<WASM<FC，按<br/>1:55"]:::wrap
    end
