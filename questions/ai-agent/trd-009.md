...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Agent 上下文压缩<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["会议纪要类比<br/>0:15"]:::core
        N2["三种压缩方法对比表<br/>0:40"]:::deep
        N3["四种触发策略图<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["System Prompt 必须完整警示<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["长文档成本降 60% 案例<br/>1:55"]:::wrap
    end
