...
flowchart LR
    ...
    subgraph Core["📖 核心讲解"]
        N1["大厨帮厨并发示意图<br/>0:15"]:::core
        N2["三大架构要求图<br/>0:40"]:::core
        N3["DAG 依赖处理图<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["电商用户ID订单依赖案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["口诀：并发执行、错误隔离、DAG 排依赖、限流防<br/>1:55"]:::wrap
    end
