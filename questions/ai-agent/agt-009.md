...
flowchart LR
    ...
    subgraph Core["📖 核心讲解"]
        N1["Thought-Action-Observation …<br/>0:20"]:::core
        N2["Prompt 模板代码截图<br/>0:55"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["ReAct vs CoT 对比表<br/>1:35"]:::practice
        N4["死循环案例：反复调同一个 API 拿 404<br/>2:15"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["“一句话：ReAct = 推理 + 行动 + 观<br/>2:50"]:::wrap
    end
