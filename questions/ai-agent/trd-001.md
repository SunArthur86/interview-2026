...
<img src="/interview-2026/images/diagram_ai-agent_trd-001.svg" alt="ReAct（Reasoning + Acting）机制的执行循环细节是什么？它是如何协调推理与行动的？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
