...
flowchart TB
    ...
    class Append decision
    class Coord special
    class Execute error
    class Final info
    class HasAction start
    class LLM process
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["ReAct 执行循环<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["盲人过迷宫类比图<br/>0:15"]:::core
        N2["Thought-Action-Observation …<br/>0:40"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["LangChain ReAct 代码示例<br/>1:10"]:::practice
        N4["运维 CPU 告警排查案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["口诀：想做看循环，设上限防死循环，Observa<br/>1:55"]:::wrap
    end
