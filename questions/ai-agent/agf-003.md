...
flowchart TB
    ...
    class Decision start
    class Dep process
    class Exec decision
    class Execute special
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Plan-Execute 啥时占优<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N2["短视问题示意图<br/>0:45"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N1["两种模式对比图<br/>0:15"]:::practice
        N3["重构依赖图截图<br/>1:10"]:::practice
        N4["系统重构案例数据<br/>1:35"]:::practice
    end
