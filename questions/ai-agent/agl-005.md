...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Prefill 和 Decode …<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["两阶段流程图<br/>0:15"]:::core
        N2["Prefill 算力瓶颈曲线<br/>0:45"]:::deep
        N3["Decode 带宽瓶颈示意<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["vLLM 部署案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["两阶段口诀卡<br/>1:50"]:::wrap
    end
