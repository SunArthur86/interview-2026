...
flowchart LR
    ...
    class Quick decision
    class Scope1 special
    class Scope2 error
    class Slow info
    class Temperature start
    class Trade process
    class Trade2 decision
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Temperature 和 Pro…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["分工明确图<br/>0:15"]:::core
        N2["参数选择卡<br/>0:45"]:::deep
        N3["避坑原则警示<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["SQL JOIN 案例<br/>1:35"]:::practice
    end
