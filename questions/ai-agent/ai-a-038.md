...
<img src="/interview-2026/images/diagram_ai-agent_ai-a-038.svg" alt="Agent如何通过模型路由降低成本?什么场景用大模型,什么场景用小模型 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
