...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["模型路由<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["任务类型与模型匹配表<br/>0:30"]:::core
        N2["规则硬路由 vs 语义软路由<br/>1:15"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["成本对比（差 10 倍）<br/>2:00"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["兜底与故障转移<br/>2:40"]:::wrap
    end
