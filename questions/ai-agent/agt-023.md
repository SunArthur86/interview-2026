...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["重排序 Reranking<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["谷歌搜索重排类比<br/>0:25"]:::core
        N2["Bi-Encoder vs Cross-Encoder…<br/>0:55"]:::deep
        N3["召回 100 → 精排 10 流程<br/>1:35"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["MMR 多样性公式<br/>2:10"]:::practice
    end
