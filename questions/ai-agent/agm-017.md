...
flowchart LR
    ...
    class Current start
    class Fed process
    class Future decision
    class Graph special
    class Multi error
    class Sleep info
    class Trend1 start
    class Trend2 process
    class Trend3 decision
    class Trend4 special
    class br error
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["未来记忆系统趋势<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大趋势总览<br/>0:15"]:::core
        N2["架构演进图<br/>0:45"]:::core
        N3["治理趋势<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["主动规划案例<br/>1:35"]:::practice
    end
