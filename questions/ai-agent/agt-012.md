...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["LATS 树搜索<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["搜索树扩展动画：Root 分出三支<br/>0:25"]:::core
        N2["Selection-Expansion-Evaluat…<br/>1:05"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["LATS vs ReAct 对比表<br/>1:50"]:::practice
        N4["排序算法选型案例：快排分支测试不过被降分<br/>2:30"]:::practice
    end
