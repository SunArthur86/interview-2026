...
flowchart TB
    ...
    class Agent start
    class Deliberative process
    class Flat decision
    class Hierarchy special
    class Hybrid error
    class Market info
    class Multi start
    class Reactive process
    class Root decision
    class Simple special
    class Use1 error
    class Use2 info
    class Use3 start
    class Use4 process
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Agent 的分类<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["五种类型表<br/>0:15"]:::core
        N3["单 vs 多 Agent<br/>1:10"]:::core
        N4["协作模式对比<br/>1:35"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["现代融合<br/>0:45"]:::practice
    end
