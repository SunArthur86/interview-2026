...
<img src="/interview-2026/images/diagram_ai-agent_agc-023.svg" alt="举一个「不是 Agent 但常被误认为 Agent」的例子. - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
