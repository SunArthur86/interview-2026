...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["不是 Agent 的例子<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["Pipeline vs Agent 对比图<br/>0:15"]:::core
        N2["固定三步 RAG 流程图<br/>0:45"]:::deep
        N3["决策权归属示意<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["文档摘要 Chain 案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["判断口诀卡<br/>1:50"]:::wrap
    end
