...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["GRPO 和 KTO<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N2["GRPO 组内对比示意<br/>0:55"]:::core
        N3["KTO 二元损失图<br/>1:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N1["三种算法对比表<br/>0:20"]:::practice
        N4["70B 微调案例数据<br/>2:05"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["算法口诀卡<br/>2:35"]:::wrap
    end
