...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["一句话解释 ReAct<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["三步循环流程图<br/>0:20"]:::core
        N3["死循环风险警示<br/>1:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N2["闭卷 vs 开卷对比<br/>0:55"]:::practice
        N4["知识库助手案例<br/>2:05"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["一句话口诀卡<br/>2:35"]:::wrap
    end
