...
<img src="/interview-2026/images/diagram_ai-agent_naa-001.svg" alt="Agent 工具调用失败后如何降级处理?设计一个容错策略. - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
