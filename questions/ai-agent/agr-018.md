...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Query Rewrite<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大策略卡<br/>0:20"]:::core
        N2["查询扩展示意<br/>0:55"]:::core
        N3["HyDE 原理图<br/>1:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["改写流程代码截图<br/>2:10"]:::practice
        N5["多轮客服案例<br/>2:45"]:::practice
    end
