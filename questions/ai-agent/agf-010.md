...
flowchart TB
    ...
    class Field1 info
    class Field2 start
    class Field3 process
    class Key decision
    class NodeA special
    class NodeB error
    class NodeC info
    class Pydantic start
    class Reducer process
    class Schema decision
    class Shared special
    class Snap error
    class State info
    class StateSnapshot start
    class add_messages process
    class br decision
    class current_intent special
    class history error
    class last info
    class list start
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["LangGraph 状态为啥要谨慎<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大风险图<br/>0:15"]:::core
        N2["Reducer 策略对比表<br/>0:45"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["并发追加翻车动画<br/>1:10"]:::practice
        N4["客服 messages 案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["设计口诀卡<br/>1:50"]:::wrap
    end
