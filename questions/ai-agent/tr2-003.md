...
flowchart TB
    ...
    class Accurate start
    class Attempt process
    class Blind decision
    class Done special
    class Evaluator error
    class External info
    class Memory start
    class Next process
    class Reflect decision
    class Reflexion special
    class Result error
    class Retry info
    class Task start
    class br process
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Reflexion 反思机制<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["学生错题本类比图<br/>0:15"]:::core
        N3["反思循环代码示例<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["Retry vs Reflexion 对比表<br/>0:40"]:::practice
        N4["代码调试变量未定义案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["口诀：Reflexion 是认知升级，Retry<br/>1:55"]:::wrap
    end
