...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["LangChain Agent<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["Tools-Agent-Executor 三件套图<br/>0:20"]:::core
        N2["五步工作流动画<br/>0:55"]:::deep
        N3["工具描述代码特写<br/>1:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["max_iterations + handle_par…<br/>2:00"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["总结回顾 & 下期预告<br/>2:30"]:::wrap
    end
