...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["ReAct 为啥写 Thought<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N3["表演性 Thought 警示<br/>1:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N1["三大价值图<br/>0:20"]:::practice
        N2["显式 vs 隐式对比表<br/>0:55"]:::practice
        N4["CSV Agent 调试案例<br/>2:05"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["价值口诀卡<br/>2:35"]:::wrap
    end
