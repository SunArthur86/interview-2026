...
flowchart TB
    ...
    class D6 start
    class Data process
    class Defense decision
    class Guardrail special
    class Input error
    class Jailbreak info
    class Prompt start
    class System process
    class Vector decision
    class br special
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["对抗性 Prompt 防御<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["五大防御层级图<br/>0:15"]:::core
        N2["XML 标签上下文隔离示例<br/>0:45"]:::deep
        N3["编码绕过攻击示意图<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["Prompt 工程挡不住角色扮演案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["口诀：五层纵深，输入输出都查，别只靠 LLM 对<br/>1:55"]:::wrap
    end
