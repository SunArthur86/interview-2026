...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["MemGPT vs 简单 RAG<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["被动 vs 主动对比<br/>0:15"]:::core
        N2["OS 分页机制图<br/>0:45"]:::core
        N3["Function Calling 示例<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["长文档案例<br/>1:35"]:::practice
    end
