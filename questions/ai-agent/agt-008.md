...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["15 道 Agent 综合面试题<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["单次调用 vs Agent 闭环对比图<br/>0:25"]:::core
        N2["ReAct 三字母拆解动画<br/>1:00"]:::core
        N3["停止条件清单<br/>1:45"]:::deep
        N4["单 Agent vs 多 Agent 对比表<br/>2:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N5["测试金字塔：单元/模拟/对抗<br/>3:30"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N6["总结回顾 & 下期预告<br/>4:20"]:::wrap
    end
