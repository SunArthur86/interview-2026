...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["GAIA Benchmark<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["人类 90% vs AI 15% 对比<br/>0:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["GAIA vs MMLU 对比表<br/>1:10"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N3["Level 3 成功率仅 10%<br/>1:40"]:::wrap
    end
