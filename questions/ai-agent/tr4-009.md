...
<img src="/interview-2026/images/diagram_ai-agent_tr4-009.svg" alt="在使用 LLM Agent 调用外部工具（如 Shell、数据库）时，如何设计沙箱机制以防止系统被破坏？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
