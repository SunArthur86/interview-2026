...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["向量化 Embedding<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["GPS 坐标类比：相近词距离近<br/>0:20"]:::core
        N2["三大模型对比：OpenAI/BGE/Jina<br/>0:50"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["归一化 + 维度权衡<br/>1:20"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["总结回顾 & 下期预告<br/>1:45"]:::wrap
    end
