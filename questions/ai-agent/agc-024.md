...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["给经理讲 Agent 风险<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["实习生能力 vs 风险图<br/>0:15"]:::core
        N2["三层管控映射表<br/>0:45"]:::deep
        N3["刹车片话术卡<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["退货转账注入案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["沟通口诀卡<br/>1:50"]:::wrap
    end
