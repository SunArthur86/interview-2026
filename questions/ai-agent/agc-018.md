...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["人在回路不破坏体验<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["三级风控流程图<br/>0:15"]:::core
        N2["预授权 + 后悔药示意<br/>0:45"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["批量操作风险动画<br/>1:10"]:::practice
        N4["删库阻断案例截图<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["分级口诀卡<br/>1:50"]:::wrap
    end
