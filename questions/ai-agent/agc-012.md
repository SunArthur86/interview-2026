...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["自己定义 LLM Agent<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大能力雷达图<br/>0:15"]:::core
        N2["开环 vs 闭环对比表<br/>0:45"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["多轮对话 vs Agent 辨析图<br/>1:10"]:::practice
        N4["数据分析 Agent 演示<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["定义口诀卡<br/>1:50"]:::wrap
    end
