...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["反应式 Agent 优缺点<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["IF-THEN 规则映射图<br/>0:15"]:::core
        N3["混合架构流程图<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["三优点三缺点对比表<br/>0:45"]:::practice
        N4["客服路由案例数据<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["混合口诀卡<br/>1:50"]:::wrap
    end
