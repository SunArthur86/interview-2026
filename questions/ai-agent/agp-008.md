...
<img src="/interview-2026/images/diagram_ai-agent_agp-008.svg" alt="如何保证模型一定输出合法 JSON - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
