...
flowchart TB
    ...
    class A start
    class Agent process
    class Agent1 decision
    class Agent2 special
    class B error
    class Break info
    class Chamber start
    class Devil process
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["避免多 Agent 互附和<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["回音室效应动画<br/>0:15"]:::core
        N2["外部工具验证流程图<br/>0:45"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["Prompt 唱反调弱效警示<br/>1:10"]:::practice
        N4["代码审查案例截图<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["避附和口诀卡<br/>1:50"]:::wrap
    end
