...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["记忆生产挑战<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["盖房子打地基类比<br/>0:25"]:::core
        N2["多租户强制 user_id 过滤<br/>0:55"]:::core
        N3["双写对账 + 被遗忘权<br/>1:35"]:::deep
        N4["冷热分层示意图<br/>2:15"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N5["VIP 升级泄露案例<br/>2:55"]:::practice
    end
