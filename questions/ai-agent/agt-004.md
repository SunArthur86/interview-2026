...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Agent 的工作流程<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["流程口诀<br/>0:15"]:::core
        N2["Input Processing<br/>0:45"]:::deep
        N3["Tool Loop 循环<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["终止判定警示<br/>1:35"]:::practice
    end
