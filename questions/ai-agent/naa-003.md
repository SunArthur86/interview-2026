...
<img src="/interview-2026/images/diagram_ai-agent_naa-003.svg" alt="如果让 Agent 连接数据库或内部系统,如何做权限控制和安全隔离 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
