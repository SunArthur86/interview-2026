...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["LangGraph 状态机<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["有向图：节点 + 边 + 共享 State<br/>0:20"]:::core
        N2["条件边路由动画：分数低→人工，分数高→生成<br/>0:55"]:::core
        N3["interrupt 暂停 + Checkpoint 回…<br/>1:35"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["LangChain vs LangGraph 对比表<br/>2:10"]:::practice
        N5["企业 RAG 转人工案例<br/>2:50"]:::practice
    end
