...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["工具调用综合题<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["FC vs JSON 对比<br/>0:25"]:::core
        N2["tool_calls.id 对应关系图<br/>1:00"]:::core
        N3["工具幻觉 + 超时处理<br/>1:40"]:::deep
        N4["双侧校验：Prompt + Pydantic<br/>2:20"]:::core
    end

    subgraph Practice["🔧 实战"]
        N5["审计日志必记项清单<br/>3:00"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N6["总结回顾 & 下期预告<br/>3:45"]:::wrap
    end
