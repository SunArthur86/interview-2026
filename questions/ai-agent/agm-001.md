...
flowchart TB
    ...
    class Mem start
    class Multi process
    class NoMem decision
    class Personal special
    class Reset error
    class Session info
    class Short start
    class Token process
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Agent 为啥要记忆<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大作用图<br/>0:15"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["无记忆失败演示<br/>0:45"]:::practice
        N3["有记忆状态延续动画<br/>1:10"]:::practice
        N4["客服 Session 案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["作用口诀卡<br/>1:50"]:::wrap
    end
