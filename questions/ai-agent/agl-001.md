...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["缩放点积注意力公式<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["公式逐项拆解图<br/>0:15"]:::deep
        N2["方差推导动画<br/>0:45"]:::core
        N3["softmax 饱和区曲线<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["FP16 NaN 翻车案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["公式口诀卡<br/>1:50"]:::wrap
    end
