...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["工具噪声害惨 ReAct<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["错误级联死循环动画<br/>0:15"]:::core
        N2["工具侧改进流程图<br/>0:45"]:::deep
        N3["模型侧验证器示意<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["旧文档噪声案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["抗噪口诀卡<br/>1:50"]:::wrap
    end
