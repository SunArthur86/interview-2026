...
flowchart TB
    ...
    class Multi start
    class ReAct process
    class Researcher decision
    class Reviewer special
    class Roles error
    class Router info
    class Single start
    class Supervisor process
    class Task decision
    class Tester special
    class Token error
    class br info
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["多 Agent 一定更强吗<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大劣势图<br/>0:15"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["三大适用场景<br/>0:45"]:::practice
        N3["过度拆分警示动画<br/>1:10"]:::practice
        N4["数据分析案例数据<br/>1:35"]:::practice
    end
