...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["ChatBot+插件=Agent？<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["静态路由 vs 动态闭环图<br/>0:15"]:::core
        N2["if-else 关键词匹配代码截图<br/>0:45"]:::deep
        N3["Agent 多步推理流程动画<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["订机票相对逻辑案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["误区警示卡<br/>1:50"]:::wrap
    end
