...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["语义切分<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["算法流程图<br/>0:20"]:::core
        N3["阈值设定示意<br/>1:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N2["三种切分对比表<br/>0:55"]:::practice
        N4["SemanticChunker 代码<br/>2:10"]:::practice
        N5["白皮书案例<br/>2:45"]:::practice
    end
