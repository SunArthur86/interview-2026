...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["文档分块策略<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["切面包类比：每片要有皮有馅<br/>0:20"]:::core
        N2["四种切法对比表<br/>0:55"]:::core
        N3["父子文档：子块检索父块生成<br/>1:35"]:::core
        N4["参数经验值：chunk_size + overlap<br/>2:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N5["法律文档条款案例<br/>2:40"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N6["总结回顾 & 下期预告<br/>3:15"]:::wrap
    end
