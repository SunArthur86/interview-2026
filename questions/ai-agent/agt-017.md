...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["RAG 基础<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N2["离线 + 在线双管道流程图<br/>1:00"]:::core
        N3["RAG vs 全文 vs 微调对比表<br/>1:45"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N1["开卷考试类比图<br/>0:25"]:::practice
        N4["电商客服退货政策案例<br/>2:20"]:::practice
        N5["检索质量是命门示意图<br/>3:00"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N6["总结回顾 & 下期预告<br/>3:40"]:::wrap
    end
