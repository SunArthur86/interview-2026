...
flowchart TB
    ...
    class Approx start
    class Choose process
    class Exact decision
    class Fast special
    class Flat error
    class Graph info
    class HNSW start
    class IndexFlatIP process
    class IndexHNSW decision
    class M special
    class Slow error
    class Tuning info
    class Use1 start
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["FlatIP vs HNSW<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["FlatIP 特点<br/>0:20"]:::core
        N2["HNSW 特点<br/>0:55"]:::core
        N3["参数控制图<br/>1:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["HNSW 代码截图<br/>2:10"]:::practice
        N5["电商评论案例<br/>2:45"]:::practice
    end
