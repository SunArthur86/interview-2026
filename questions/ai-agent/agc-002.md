...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Agent = LLM + P +…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四模块架构图<br/>0:15"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["缺 Planning 的错误演示<br/>0:45"]:::practice
        N3["缺 Memory 的反复重写动画<br/>1:10"]:::practice
        N4["数据分析 Agent 案例图<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["四要素缺一不可<br/>1:50"]:::wrap
    end
