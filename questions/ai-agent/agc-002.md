...
<img src="/interview-2026/images/diagram_ai-agent_agc-002.svg" alt="为什么说 Agent = LLM + Planning + Memory + Tools?缺一块会怎样 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
