...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["模型量化<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["FP16 → INT8 → INT4 显存递减柱状图<br/>0:30"]:::core
        N2["PTQ vs QAT 对比<br/>1:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["GPTQ/AWQ 算法示意<br/>1:50"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["部署生态地图（GGUF/PTQ）<br/>2:30"]:::wrap
    end
