...
<img src="/interview-2026/images/diagram_ai-agent_ai-a-037.svg" alt="生产Agent如何实现可观测性?需要追踪哪些关键指标 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
