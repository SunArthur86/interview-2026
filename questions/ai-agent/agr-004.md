...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["PDF 解析常见坑<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["四大坑点图<br/>0:20"]:::core
        N3["避坑原则卡<br/>1:30"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N2["工具对比表<br/>0:55"]:::practice
        N4["Unstructured 代码截图<br/>2:10"]:::practice
        N5["法律合同案例<br/>2:45"]:::practice
    end
