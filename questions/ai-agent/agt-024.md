...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["RAG 高级模式<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["进化路径：翻字典→查地图→问专家<br/>0:25"]:::core
        N2["GraphRAG 知识图谱构图<br/>1:00"]:::core
        N3["Agentic + Self + Corrective…<br/>1:45"]:::deep
        N4["Adaptive RAG 路由降本<br/>2:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N5["金融风控两跳查关联案例<br/>3:10"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N6["总结回顾 & 下期预告<br/>3:50"]:::wrap
    end
