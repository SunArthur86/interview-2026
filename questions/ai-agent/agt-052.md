...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Transformer 架构<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["一目十行类比<br/>0:25"]:::core
        N2["Q/K/V 三元组公式<br/>0:55"]:::core
        N3["Encoder vs Decoder 对比<br/>1:35"]:::deep
        N4["Multi-Head + 位置编码<br/>2:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N5["RoPE 长文本外推案例<br/>2:50"]:::practice
    end
