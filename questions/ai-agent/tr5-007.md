...
flowchart TB
    ...
    class Graph start
    class Mem process
    class Retrieve1 decision
    class Retrieve2 special
    class Store1 error
    class Store2 info
    class Vec start
    class Weak1 process
    class Weak2 decision
    class br special
    Mem["记忆类型"] --> Vec["向量记忆"]
    Mem --> Graph["图记忆"]
    Vec --> Store1["存: 向量库"]
...
flowchart LR
    ...
    subgraph Core["📖 核心讲解"]
        N1["字典 vs 地图类比<br/>0:15"]:::core
        N2["本质对比表<br/>0:40"]:::core
        N3["图多跳推理示意图<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["图构建成本高警示<br/>1:35"]:::practice
    end
