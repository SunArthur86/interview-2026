...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["向量 vs 图记忆<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["索引卡片 vs 地铁线路图<br/>0:15"]:::core
        N2["向量 vs 图本质对比表<br/>0:40"]:::core
        N3["图多跳推理路径图<br/>1:10"]:::core
    end

    subgraph Practice["🔧 实战"]
        N4["向量粗排+图精排架构<br/>1:35"]:::practice
    end
