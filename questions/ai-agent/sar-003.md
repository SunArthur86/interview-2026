...
flowchart TB
    ...
    class Action start
    class CRAG process
    class Compose decision
    class Conf special
    class Docs error
    class Eval info
    class Gen start
    class Query process
    class Retrieve decision
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["CRAG 纠正检索<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["CRAG 三档决策流程图<br/>0:15"]:::core
        N2["评估器三档打分示意图<br/>0:45"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["CRAG vs Self-RAG 对比表<br/>1:15"]:::practice
        N4["企业新规联网抓取案例<br/>1:40"]:::practice
    end
