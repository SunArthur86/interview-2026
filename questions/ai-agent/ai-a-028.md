...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["OpenAI Swarm<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["无状态 + Context Variables<br/>0:30"]:::core
        N2["Handoff 控制权转移动画<br/>1:15"]:::core
    end

    subgraph Practice["🔧 实战"]
        N3["Handoff 中更新 Context 示意<br/>2:00"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N4["vs AutoGen/CrewAI<br/>2:40"]:::wrap
    end
