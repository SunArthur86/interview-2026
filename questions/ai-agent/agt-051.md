...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["多 Agent 生产挑战<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["给马套缰绳设路障类比<br/>0:25"]:::core
        N2["Token 成本 + 延迟优化<br/>0:55"]:::core
        N3["死循环四道防线<br/>1:35"]:::core
        N4["错误隔离机制<br/>2:10"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N5["JSON true vs True 耗尽预算案例<br/>2:50"]:::practice
    end
