...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Agent 停止条件<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["软终止硬终止分类图<br/>0:15"]:::core
        N2["死循环检测动画<br/>0:45"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["伪 Finish Token 警示图<br/>1:10"]:::practice
        N4["代码调试死循环案例<br/>1:35"]:::practice
    end

    subgraph Wrap["🎬 收尾"]
        N5["停止条件口诀卡<br/>1:50"]:::wrap
    end
