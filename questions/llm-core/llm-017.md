...
<img src="/interview-2026/images/diagram_llm-core_llm-017.svg" alt="为什么现在的大语言模型都用Decoder-only - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
