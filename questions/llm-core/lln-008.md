...
<img src="/interview-2026/images/diagram_llm-core_lln-008.svg" alt="什么是自回归语言模型和n-gram模型 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
