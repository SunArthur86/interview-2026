...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["SFT中的loss是怎么做计算的<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["只对回答部分计算交叉熵，屏蔽问题部分<br/>0:36"]:::core
        N2["只计算Response部分的Loss，Promp<br/>1:12"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["需对Logits进行Shift操作，使预测Tok<br/>1:48"]:::practice
    end
