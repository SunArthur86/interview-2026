...
flowchart TB
    ...
    class P4 process
    class PPO decision
    class PPOUpd special
    class Policy error
    class Preference info
    class Prompt start
    class RM process
    class Reference decision
    class Rejected special
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["分析一下DPO和PPO的区别<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["PPO基于奖励优化策略，DPO基于偏好直接优化策<br/>0:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["流程对比图解<br/>1:00"]:::practice
    end
