...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["DeepSeekV3技术特点<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["通过MLA压缩KV、FP8提升计算密度、Dual<br/>0:40"]:::core
        N2["MLA通过低秩分解压缩KV Cache，大幅降低<br/>1:20"]:::deep
        N3["采用FP8混合精度训练，提升计算吞吐量，同时保持<br/>2:00"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["DualPipe算法重叠计算与通信，隐藏跨节点A<br/>2:40"]:::practice
    end
