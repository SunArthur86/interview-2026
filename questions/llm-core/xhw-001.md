...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["Transformer前馈神经网络…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["通过引入非线性，增强模型捕捉复杂特征的能力。<br/>0:40"]:::core
        N2["三大激活函数演变图解<br/>1:20"]:::deep
        N3["ReLU易致死神经元，而GELU在零点平滑过渡，<br/>2:00"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["现代LLM多采用SwiGLU：虽增加参数量，但收<br/>2:40"]:::practice
    end
