...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["VLLM的加速方法<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["PagedAttention解决显存碎片，Con<br/>0:40"]:::core
        N2["显存优化(核心)图解<br/>1:20"]:::core
        N3["算力优化图解<br/>2:00"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["附加提效图解<br/>2:40"]:::practice
    end
