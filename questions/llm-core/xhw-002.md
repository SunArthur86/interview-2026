...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["LoRA是怎样进行初始化矩阵的<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["初始权重更新置零，让模型从预训练状态平稳过渡。<br/>0:40"]:::core
        N2["核心口诀图解<br/>1:20"]:::core
        N3["原因图解<br/>2:00"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["若A初始化方差过大，会导致模型接入不平滑，引发训<br/>2:40"]:::practice
    end
