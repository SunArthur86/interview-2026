...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["DeepSeek-R1-Zero的…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["指完全跳过监督微调，仅利用强化学习从零开始训练模<br/>0:36"]:::core
        N2["Zero源自AlphaZero，指无需人类标注数<br/>1:12"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N3["跳过SFT阶段，直接在Base Model上应用<br/>1:48"]:::practice
    end
