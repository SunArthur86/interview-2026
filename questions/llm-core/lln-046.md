...
<img src="/interview-2026/images/diagram_llm-core_lln-046.svg" alt="大模型中常用的分词算法有哪些?BPE和BBPE的区别是什么 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
