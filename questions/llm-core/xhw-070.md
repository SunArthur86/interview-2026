...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["DeepSeek-R1-Zero中…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["利用强化学习通过组内相对优势估计优化策略，无需价<br/>0:40"]:::core
        N2["采用GRPO算法，无需训练Critic网络，通过<br/>1:20"]:::deep
        N3["对同一Prompt采样G个输出，利用规则打分，通<br/>2:00"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["优化目标包含最大化期望奖励和KL散度约束，防止策<br/>2:40"]:::practice
    end
