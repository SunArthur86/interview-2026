...
**展开框架：**
1. **选型决策看四维** — 能力(模态/推理) vs 成本(API/算力) vs 合规 vs 生态
2. **私有部署首选开源** — Qwen/Llama，其中Qwen称霸中文场景，Llama深耕英文定制
3. **闭源天花板** — Claude 3.5主导代码/长文，GPT-4o主导多模态与复杂Agent

**收尾：** 以上三点都能配合实战聊。我可以展开任一要点，比如「MoE 模型推理为什么便宜？—— 每次只激活部分专家，实际计算量远小于总参数量」这类追问您感兴趣吗？
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡 | "【美团面经】使用过的 AI 基座模型有什么，30 秒讲清楚。" | 开场钩子 |
| 0:36 | 概念定义动画 | "一句话：根据场景需求在闭源巨头和开源SOTA之间做Trade-off。" | 核心定义 |
