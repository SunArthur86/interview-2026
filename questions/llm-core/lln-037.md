...
<img src="/interview-2026/images/diagram_llm-core_lln-037.svg" alt="Lora 相比全参数微调可以节省多少计算量和显存 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
