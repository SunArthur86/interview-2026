...
**展开框架：**
1. **一句话** — 学新知识用RAG(外挂)，学新能力/风格用微调(内化)
2. **RAG优势** — 成本低、实时生效、准确实时；劣势：Context长限制、延迟高
3. **微调优势** — 延迟低、省Token、风格稳定；劣势：成本高、知识易陈旧

**收尾：** 以上三点都能配合实战聊。我可以展开任一要点，比如「微调和RAG能结合吗？——可以，微调改变行为模式+RAG补充实时知识」这类追问您感兴趣吗？
...
| 时间 | 画面/字幕 | 口播台词 | 讲解要点 |
|------|----------|----------|----------|
| 0:00 | 标题卡 | "【字节面经】微调（Fine-tuning）和RAG的使用场景有什么区别，30 秒讲清楚。" | 开场钩子 |
| 0:36 | 概念定义动画 | "一句话：RAG外挂知识库解决“不知道”，微调内化技能解决“不会做”。" | 核心定义 |
