...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["FLOPs计算<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["量化模型训练或推理过程中的浮点运算次数，用于衡量<br/>0:40"]:::core
        N2["FLOPs定义图解<br/>1:20"]:::core
        N3["矩阵乘法图解<br/>2:00"]:::deep
    end

    subgraph Practice["🔧 实战"]
        N4["Transformer瓶颈：Attention层<br/>2:40"]:::practice
    end
