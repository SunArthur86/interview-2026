...
<img src="/interview-2026/images/diagram_llm-core_lln-031.svg" alt="模型在SFT后会出现“复读机”情况该如何debug,以及出现的原因是什么 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
