...
<img src="/interview-2026/images/diagram_ant-risk_ant-risk-011.svg" alt="【蚂蚁风控】HBase 的底层架构？LSM 树原理？风控的用户画像怎么存在 HBase？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
