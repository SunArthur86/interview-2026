...
<img src="/interview-2026/images/diagram_framework_tr2-003.svg" alt="在构建高并发网关或服务时，Netty 的 `EpollEventLoopGroup` 相比于默认的 `NioEventLoopGroup` 在 Linux 环境下有哪些性能优势？请从系统调用角度简要说明。 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
