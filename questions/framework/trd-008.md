...
<img src="/interview-2026/images/diagram_framework_trd-008.svg" alt="Spring Cloud Gateway 是基于 Netty 实现的响应式网关，它与传统的基于 Servlet（如 Zuul 1.x）的阻塞网关模型在处理高并发长连接时有何优势？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
