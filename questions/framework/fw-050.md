...
<img src="/interview-2026/images/diagram_framework_fw-050.svg" alt="Spring AOP 的 JDK 动态代理和 CGLIB 代理有什么区别？什么时候用哪个？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
