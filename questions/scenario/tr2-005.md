...
<img src="/interview-2026/images/diagram_scenario_tr2-005.svg" alt="在设计秒杀系统时，为了防止库存超卖，Redis Lua 脚本和 Watch 机制（CAS 乐观锁）是实现原子性扣减的两种常见手段。对比它们的优缺点及适用场景。 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
