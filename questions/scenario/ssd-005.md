...
<img src="/interview-2026/images/diagram_scenario_ssd-005.svg" alt="如何设计一个高性能消息队列？（Kafka/RocketMQ架构设计） - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
