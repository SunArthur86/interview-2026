...
<img src="/interview-2026/images/diagram_scenario_trd-012.svg" alt="在处理百万级数据导出时，如何避免 JVM 发生 OOM（Out Of Memory）？请结合 MySQL 的流式查询和 HTTP 响应特性进行设计。 - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
