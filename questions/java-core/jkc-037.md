...
flowchart TD
    ...
    class EL2 special
    class ELN error
    class EventLoop info
    class EventLoop1 start
    class EventLoop2 process
    class EventLoopN decision
    class Group special
    class NioEventLoopGroup error
    class Read info
    class Register start
    class Requests process
...
flowchart LR
    ...
    subgraph Core["讲解"]
        B["核心机制：基于Java NIO，采用异步非阻塞IO与…"]:::core
        C["高性能：因为采用Reactor线程模型，所以能分离I…"]:::deep
    end
