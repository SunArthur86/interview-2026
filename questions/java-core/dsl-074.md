...
feynman:
  ...
  analogy: Proxy比defineProperty像升级版监控器，能全方位无死角监听（数组增删）；Composition API像把零散的工具按功能分组打包，比乱放抽屉（Options API）好找。
...
<img src="/interview-2026/images/diagram_java-core_dsl-074.svg" alt="核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
