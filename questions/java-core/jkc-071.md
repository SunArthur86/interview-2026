...
sequenceDiagram
    ...
    class Acceptor1 info
    class Acceptor2 start
    class Acceptor3 process
    class L decision
    class Learner special
    class P error
    class Prepare info
    class Promise start
...
flowchart LR
    ...
    subgraph Intro["引入"]
        A["Paxos三种角色：Proposer，Acceptor，Le…"]:::intro
    end

    subgraph Core["讲解"]
        B["三角色定义：Proposer 提案，Acceptor…"]:::core
        C["核心约束：Proposer 的提案只要被半数以上 A…"]:::deep
    end
