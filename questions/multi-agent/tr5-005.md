...
flowchart TD
    ...
    class E2 start
    class F process
    class Former decision
    class G special
    class H error
    class LLM info
    class Q start
    class S1 process
    class Temporal decision
    class Tubelet special
    class VideoMAE error
    class br info
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["针对视频理解任务，多模态大模型如何…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["核心挑战图解<br/>0:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["策略一图解<br/>1:00"]:::practice
    end
