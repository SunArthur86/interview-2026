...
flowchart TD
    ...
    class H error
    class Manager info
    class UserProxy start
    class is_termination_msg process
    class max_reply decision
...
flowchart LR
    ...
    subgraph Intro["🎥 引入"]
        N0["在 AutoGen 的多 Agen…<br/>0:00"]:::intro
    end

    subgraph Core["📖 核心讲解"]
        N1["通过关键词、次数或外部干预设定停止熔断机制。<br/>0:30"]:::core
    end

    subgraph Practice["🔧 实战"]
        N2["终止条件图解<br/>1:00"]:::practice
    end
