...
<img src="/interview-2026/images/diagram_multi-agent_tr5-001.svg" alt="在多模态大模型（如LLaVA）中，简单的线性投影层（Linear Projection）是如何连接视觉编码器和LLM的…" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
## 记忆要点
