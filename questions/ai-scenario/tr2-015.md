...
<img src="/interview-2026/images/diagram_ai-scenario_tr2-015.svg" alt="GraphRAG 相比传统向量 RAG，在构建“全局索引”时使用了什么核心技术？它在解决“分散信息汇总”类问题时为何表现更好？ - 核心知识点图" style="max-width:100%;height:auto;border:1px solid var(--border);border-radius:8px;margin:1em 0;" />
